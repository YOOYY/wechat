...
return [
    ...
    'app_id'  => env('WECHAT_APPID', 'wx14286b183e4344e3'),         // AppID
    'secret'  => env('WECHAT_SECRET', 'ba69cb275c3e81bcd7ace2082c95c48a'),     // AppSecret
    'token'   => env('WECHAT_TOKEN', 'anCIQEYEghQcJbMkK'),          // Token
    'aes_key' => env('WECHAT_AES_KEY', 'anCIQEYEghQcJbMkKY3CIhyWtNphvwTAcODTbHwjhf9'), // EncodingAESKey
